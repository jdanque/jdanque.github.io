...
var ICON = 'https://jdanque.github.io/p/trello-tree-view/img/logo_white.png?v=1.5.7';
...
var openTreeViewOverlay = function (t, opts) {
	...
	t.get('board', 'private', 'theme').then(function(_accentColor){
	  ...
	  return t.modal({
		url: 'https://jdanque.github.io/p/trello-tree-view/view/treeview.html?v=1.5.7',
		fullscreen : false,
...
TrelloPowerUp.initialize({
	...
	'show-authorization': function(t, options){
		return t.popup({
			...
			url: 'https://jdanque.github.io/p/trello-tree-view/view/auth.html?v=1.5.7',
			height: 140,
		});
	},
	'show-settings': function(t, options){
		return t.popup({
			...
			url: 'https://jdanque.github.io/p/trello-tree-view/view/settings.html?v=1.5.7',
			height: 184
		});
	}
